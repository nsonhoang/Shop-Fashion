  ...
  return (
    ...
    <div className="w-full bg-white border-b border-gray-100">
      ...
      >
        ...
        <div className="shrink-0">
          <CategoryItem
            link="/products?gender=women&category=tshirts"
            title="Áo Thun"
          />
        </div>
        <div className="shrink-0">
          <CategoryItem
            link="/products?gender=women&category=pants"
            title="Quần Dài"
          />
        </div>
        <div className="shrink-0">
          <CategoryItem
            link="/products?gender=women&category=shoes"
            title="Giày Dép"
          />
        </div>
        <div className="shrink-0">
          <CategoryItem
            link="/products?gender=women&category=accessories"
            title="Phụ Kiện"
          />
        </div>
        <div className="shrink-0">
